      ...
      <div>
        <div className="box-border relative h-432 w-343 mt-6 border-3 rounded-3xl drop-shadow-md p-3 max-w-sm bg-white  border border-black-200 ">
          ...
          <div className="flex flex">
            ...
            <div>
              <button className="absolute top-3 text-xl right-4 text-gray-500 hover:text-gray-800 background-transparent font-bold uppercase px-1 pt-3 text-sm outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">
